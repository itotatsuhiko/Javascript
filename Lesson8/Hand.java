...
public class Hand {
	...
	/**
	 * カードを見る
	 * positionは0からgetNumberOfCard() の範囲で指定すること
	 *
	 * @param  position カードの位置
	 * @return positon  で指定されたカードの位置カード。範囲外の場合はnullを返す
	 **/
	 ...
	 *
	 * @param position  カードの位置
	 * @return position で指定されたカードの位置カード。範囲外の場合はnullを返す
	 **/
